    ...
    $(document).on('click', '#btn-edit', function(){
      var idingreso = $(this).closest('tr').find('#idingreso').val();
      $("#loader-pages").show();
      changeTitle("Detalles de Ingreso");
      $("#btn-new").hide();
      $("#btn-select").hide();  
      $("#btn-list").show();
      $("#cab").fadeOut("slow");
      $(".main").fadeOut('slow', function() {
        $("#loader-pages").hide();  
        $(".other").load("show.php?idingreso="+idingreso, function(){
            $(".other").fadeIn("slow");
        });
      });
    });
