...
<div class="content-wrapper" ng-app="ventaApp" ng-controller="ventaController" >
  <!-- Main content -->
  <section class="content">
      ...
      <form method="post" action="registrar.php">
        <div class="box-body">
                      ...
                      <div class="row">
                        <div class="col-lg-4 col-md-4 col-sm-10">
                          <div class="form-group">
                            <label>Cliente</label>
                            <select name="idcliente" class="form-control select2 select2-hidden-accessible" name="supplier_id" id="supplier_id" required="" tabindex="-1" aria-hidden="true">
                ...
                <table id="detalles" class="table table-striped table-bordered">
                  ...
                  <tbody>                     
                        <tr ng-repeat="pd in productosAdd">
                          ...
                          <td>{{ pd.producto }}</td>
                          <td>{{ pd.cantidad }}</td>
                          <td>{{ pd.precio_venta | currency:'S/.'}}</td>
                          <td>{{ pd.descuento | currency:'S/.'}}</td>
          ...
          <div class="box-footer" id="guardar">
            ...
            <button type="submit" class="btn btn-success pull-right "><i class="fa fa-floppy-o"></i> Registrar Venta</button>
          </div>
        </div>
      <!-- /.box-body -->
      </form>
    ...
    <!-- /.box -->
    <?php
    include '../../modals/cargaProductosVenta.php';
    ?>
  </section>
  <!-- /.content -->
</div>
...
<script type="text/javascript" src="../../dist/js/venta_detalle.js"></script>
