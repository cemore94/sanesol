...
$active_clientes="";
$active_ventanueva="";
$active_administrarventas="active";
$active_facturacion="";
$active_reportes="";
...
<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="page-header" style="border-bottom-color: #3c8dbc;  border-bottom-width: 2px;">
        <h4 class="text-info box-title" id="page-title">Lista de Ventas</h4>
      </div>
      <div class="row">
        ...
        <div class="col-lg-6 col-md-6 col-xs-9 col-sm-9">
          <button style="display:none;" type="button" class="btn btn-success  btn-sm pull-right" id="btn-list"><span class="glyphicon glyphicon-list"></span>  Mostrar  Ventas</button>
              ...
              <div class="row">
                <div class="col-lg-3 col-md-3 col-xs-6 col-sm-6">
                  <div class="input-group input-group-sm" style="width: 250px;">
                     <input type="text" name="table_search" id="q"  onkeyup="load(1);" class="form-control pull-right" placeholder="Buscar por Cliente, Factura ...">
 ...
 ?>
  ...
  <script type="text/javascript" src="../../dist/js/venta.js"></script>
