...
if ($action == 'ajax') {
    ...
    $stmt  = $venta->readAll($sWhere, $offset, $per_page);
            ...
            <div class="table-responsive">
              <table class="table table-condensed table-striped table-bordered table-hover">
                <tbody>
                  ...
                  ?>
                    <tr>
                      <input type="hidden" id="idventa" value="<?php echo $row['idventa']; ?>">
